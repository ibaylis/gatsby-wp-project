...
import { SlideWrapper, buttonWrapper, Button, SliderWrapper, ButtonWrapper } from './styles/HeroSliderStyles';
...
const HeroSlider = () => {
    ...
    const handleNextClick = () => {
        setState(prev => ({
            ...
            autoSlide: false,
            activeIndex:
                (prev.activeIndex + 1) % prev.slides.length,
        }));
    };
