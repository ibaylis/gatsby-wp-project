        ...
        <div className="container">
            <div className="row" style={{ marginBottom: '40px' }}>
                ...
                <PageContent className="col-lg-9">
                    ...
                    <h1 dangerouslySetInnerHTML={{ __html: data.currentPage.content }} />
                </PageContent>
            </div>
        </div>
    </Layout>
...
//First two queries the first one is to grab the parent children so that when we want to display the same menu for all the children
//The second query is so that, while we are on the parent (main) page, we will display the child (sub) pages
